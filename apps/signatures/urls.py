...
urlpatterns = [
    ...
    path('<int:pk>/download/<int:file_pk>/', views.download_individual_file, name='download_file'),
    ...
    path('<int:pk>/archive/', views.archive_document, name='archive'),
    path('<int:pk>/unarchive/', views.unarchive_document, name='unarchive'),
    path('<int:pk>/tags/add/', views.add_tag, name='add_tag'),
    path('<int:pk>/tags/remove/', views.remove_tag, name='remove_tag'),
